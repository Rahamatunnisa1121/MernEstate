        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
              ...
              <div className='flex gap-4'>
                <input className='p-3 text-pink-800 border border-pink-300 rounded w-full' type="file" id="images" accept="image/*" multiple />
                <button className='p-3 border font-semibold border-pink-300  text-pink-700 rounded uppercase hover:shadow-lg disabled:opacity-80'>Upload</button>
              </div>
